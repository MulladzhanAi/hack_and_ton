...
class _$ReportDetailStateImpl implements _ReportDetailState {
  _$ReportDetailStateImpl({this.isLoading = false});
  ...
  @override
  String toString() {
    return 'ReportDetailState(isLoading: $isLoading)';
  }
...
abstract class _ReportDetailState implements ReportDetailState {
  factory _ReportDetailState({final bool isLoading}) = _$ReportDetailStateImpl;
